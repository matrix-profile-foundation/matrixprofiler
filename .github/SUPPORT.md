...
Thanks for using `matrixprofiler`. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/matrix-profile-foundation/matrixprofiler/issues) to make sure the 
