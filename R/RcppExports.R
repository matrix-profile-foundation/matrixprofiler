...
fftw <- function(z, inverse) {
    .Call(`_matrixprofiler_fftw`, z, inverse)
}
...
parallel_mass3_rcpp <- function(query_window, data_ref, data_size, window_size, data_mean, data_sd, query_mean, query_sd, k = 8192L) {
    .Call(`_matrixprofiler_parallel_mass3_rcpp`, query_window, data_ref, data_size, window_size, data_mean, data_sd, query_mean, query_sd, k)
}
