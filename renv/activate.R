...
local({
  ...
  renv_bootstrap_download_cran_latest <- function(version) { #nolint
  ...
  renv_bootstrap_download_cran_latest_find <- function(version) { #nolint
  ...
  renv_bootstrap_download_cran_archive <- function(version) { #nolint
  ...
  renv_bootstrap_library_root_name <- function(project) { #nolint
  ...
  renv_bootstrap_validate_version <- function(version) { #nolint
