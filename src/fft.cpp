 ...
 * 2020-09-16. Mostly complying with  C++ Standard Library (STD).
 *
...
std::vector<std::complex<double>> fftw(std::vector<double> z, bool inverse) {
  ...
  std::vector<std::complex<double>> final = fftw(res, inverse);
