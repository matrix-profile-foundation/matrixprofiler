...
RcppExport SEXP _matrixprofiler_scrimpab_rcpp(SEXP data_refSEXP, SEXP query_refSEXP, SEXP window_sizeSEXP, SEXP progressSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const NumericVector >::type data_ref(data_refSEXP);
    ...
    Rcpp::traits::input_parameter< uint32_t >::type window_size(window_sizeSEXP);
    Rcpp::traits::input_parameter< bool >::type progress(progressSEXP);
    rcpp_result_gen = Rcpp::wrap(scrimpab_rcpp(data_ref, query_ref, window_size, progress));
    return rcpp_result_gen;
END_RCPP
}
// stamp_rcpp
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_matrixprofiler_scrimpab_rcpp", (DL_FUNC) &_matrixprofiler_scrimpab_rcpp, 4},
